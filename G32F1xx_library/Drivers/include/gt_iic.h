/*****************************************************************************
 *   GT_IIC:  Head file for Gorgetek MCU IIC(IIC compatible) application
 *
...
#define I2C1                ((G32F1_IIC_TypeDef                *) GT_I2C1_BASE)
#define I2C2                ((G32F1_IIC_TypeDef                *) GT_I2C2_BASE)
//IIC mode
...
void IIC_ClearFlag(G32F1_IIC_TypeDef *IIC, uint8_t CONCLR );
...
#define IIC1_SCL_PB6  (GT_AFIO->PB6  = 0x4|(1<<10))	//Open Drain
#define IIC1_SDA_PB7  (GT_AFIO->PB7  = 0x4|(1<<10)) //Open Drain
#define IIC1_SCL_PB8  (GT_AFIO->PB8  = 0x4|(1<<10)) //Open Drain
#define IIC1_SDA_PB9  (GT_AFIO->PB9  = 0x4|(1<<10)) //Open Drain
#define IIC2_SCL_PB10 (GT_AFIO->PB10 = 0x4|(1<<10)) //Open Drain
#define IIC2_SDA_PB11 (GT_AFIO->PB11 = 0x4|(1<<10)) //Open Drain
