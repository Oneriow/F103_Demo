/*****************************************************************************
 *   gt_pwm.h:  Header file for G32F1xx Microprocessors
 *
...
#define TIM1	((G32F1_PWM_TypeDef	 *) GT_TIM1_BASE)
#define TIM8	((G32F1_PWM_TypeDef	 *) GT_TIM8_BASE)
...
#define TIM1_PWM1_PA7  (GT_AFIO->PA7  = 0x16)	
#define TIM1_PWM2_PA8  (GT_AFIO->PA8  = 0x16)	
#define TIM1_PWM3_PB0  (GT_AFIO->PB0  = 0x16)
#define TIM1_PWM4_PA9  (GT_AFIO->PA9  = 0x16)
#define TIM1_PWM5_PB1  (GT_AFIO->PB1  = 0x16)
#define TIM1_PWM6_PA10 (GT_AFIO->PA10 = 0x16)
#define TIM1_PWM7_PA11 (GT_AFIO->PA11 = 0x16)
#define TIM1_PWM8_PA12 (GT_AFIO->PA12 = 0x16)

#define TIM1_PWM1_PB13 (GT_AFIO->PB13 = 0x6)	
#define TIM1_PWM3_PB14 (GT_AFIO->PB14 = 0x6)
#define TIM1_PWM5_PB15 (GT_AFIO->PB15 = 0x6)

#define TIM1_PWM1_PE8  (GT_AFIO->PE8  = 0x6)	
#define TIM1_PWM2_PE9  (GT_AFIO->PE9  = 0x6)	
#define TIM1_PWM3_PE10 (GT_AFIO->PE10 = 0x6)
#define TIM1_PWM4_PE11 (GT_AFIO->PE11 = 0x6)
#define TIM1_PWM5_PE12 (GT_AFIO->PE12 = 0x6)
#define TIM1_PWM6_PE13 (GT_AFIO->PE13 = 0x6)
#define TIM1_PWM7_PE14 (GT_AFIO->PE14 = 0x6)
#define TIM1_PWM8_PE8  (GT_AFIO->PE7  = 0x6)

#define TIM8_PWM1_PA7  (GT_AFIO->PA7  = 0x4)	
#define TIM8_PWM2_PC6  (GT_AFIO->PC6  = 0x4)	
#define TIM8_PWM3_PB0  (GT_AFIO->PB0  = 0x4)
#define TIM8_PWM4_PC7  (GT_AFIO->PC7  = 0x4)
#define TIM8_PWM5_PB1  (GT_AFIO->PB1  = 0x4)
#define TIM8_PWM6_PC8  (GT_AFIO->PC8  = 0x4)
#define TIM8_PWM7_PC9  (GT_AFIO->PC9  = 0x4)
#define TIM8_PWM8_PA0  (GT_AFIO->PA0  = 0x4)


#define TIM1_BKIN_PA6  (GT_AFIO->PA6  = 0x16)
#define TIM1_BKIN_PB12 (GT_AFIO->PB12 = 0x16)
#define TIM1_BKIN_PE15 (GT_AFIO->PE15 = 0x16)

#define TIM8_BKIN_PA6  (GT_AFIO->PA6  = 0x14)
