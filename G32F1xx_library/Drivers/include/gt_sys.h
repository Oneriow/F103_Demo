/*****************************************************************************
 *   gt_sys.h:  Header file for G32F1xx Microprocessors
 *
 *   Copyright(C) 2015¡£ 
 *   All rights reserved.
 *
...
struct SYSAPB1CLKCTRL_BITS {					   		  // bit description
        ...
        uint32_t RSVD4:1;                     //
        uint32_t CANCLK:1;                    //Enables clock for CAN.	
				uint32_t RSVD5:1;                     //
...
struct APB2RESET_BITS {							           // bit description
				...
				uint32_t ADC3RSTN:1;                   //Enables clock for ADC3. 
				uint32_t RSVD2:3;                      //
				uint32_t TIM9RSTN:1;                   //Enables clock for TIM9. 
				uint32_t TIM10RSTN:1;                  //Enables clock for TIM10. 
				uint32_t TIM11RSTN:1;                  //Enables clock for TIM11. 
				uint32_t RSVD3:10;                     //  
};
union APB2RESET_REG {
				uint32_t				all;
...
struct APB1RESET_BITS {							           // bit description
        ...
        uint32_t RSVD4:1;                      //
        uint32_t CANRSTN:1;                    //Enables clock for CAN.	
				uint32_t RSVD5:1;                      //
...
} G32F1_SYSCON_TypeDef;

//Re_Define PMU, IOCON and SYSCON
#define PMU					  ((G32F1_PMU_TypeDef     *) GT_PWR_BASE    )
#define IOCON					((G32F1_IOCON_TypeDef   *) GT_AFIO_BASE   )
#define SYSCON				((G32F1_SYSCON_TypeDef  *) GT_SYSCON_BASE )
