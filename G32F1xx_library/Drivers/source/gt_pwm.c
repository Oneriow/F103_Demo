...
** 
*****************************************************************************/
void PWM_Init(G32F1_PWM_TypeDef *PWM,uint16_t freq,uint8_t pair, uint8_t align, uint8_t polarity)
{
...
** 
*****************************************************************************/
void PWM_DeInit(G32F1_PWM_TypeDef *PWM)
{
	//Disable PWM clk
	if(PWM==TIM1)
...
** 
*****************************************************************************/
void PWM_SetRelaodFreq(G32F1_PWM_TypeDef *PWM,uint8_t everytimes)
{
...
** 
*****************************************************************************/
void PWM_SetDuty(G32F1_PWM_TypeDef *PWM,uint8_t channelindex, uint16_t dutyval)
{
	uint8_t i;
...
** 
*****************************************************************************/
void PWM_SetRiseDeadZone(G32F1_PWM_TypeDef *PWM,uint16_t rdtimeticks)
{
...
** 
*****************************************************************************/
void PWM_SetFallDeadZone(G32F1_PWM_TypeDef *PWM,uint16_t rdtimeticks)
{
...
** 
*****************************************************************************/
void PWM_EnableFaultProtect(G32F1_PWM_TypeDef *PWM,uint8_t faults, uint8_t cleartype, uint8_t faultint)
{
	switch(faults)
	{
		case 0:
...
** 
*****************************************************************************/
void PWM_ClearFault(G32F1_PWM_TypeDef *PWM)
{
...
** 
*****************************************************************************/
void PWM_Start(G32F1_PWM_TypeDef *PWM)
{
	// Enable PWM0
...
** 
*****************************************************************************/
void PWM_Stop(G32F1_PWM_TypeDef *PWM)
{
	// Disable PWM0
...
** 
*****************************************************************************/
void	PWM_EnableInt(G32F1_PWM_TypeDef *PWM,uint8_t inttype)
{
...
** 
*****************************************************************************/
void PWM_ADCTrigger(G32F1_PWM_TypeDef *PWM,uint8_t channel)
{
	uint8_t i;
...
** 
*****************************************************************************/
void PWM_TriggerSoftFault(G32F1_PWM_TypeDef *PWM)
{
