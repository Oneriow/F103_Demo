...
*****************************************************************************/
void TIM_Init(G32F1_TIM_TypeDef *ct, uint32_t tickpersecond)
{
if (ct == TIM2)
	{
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
void TIM_ConfigMatch(G32F1_TIM_TypeDef *ct, uint16_t ticks, uint8_t action)
{
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
void TIM_SetTimerCounter(G32F1_TIM_TypeDef *ct, uint16_t tick)
{
	ct->PC.bit.PC=tick;
	return;
}
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
void TIM_ResetTimerCounter(G32F1_TIM_TypeDef *ct)
{
	ct->PC.bit.PC=0;
	return;
}
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
uint16_t TIM_GetTimerCounter(G32F1_TIM_TypeDef *ct)
{
	return ct->PC.bit.PC;
}
/*****************************************************************************
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
void TIM_ClearIntFlag(G32F1_TIM_TypeDef *ct)
{
	ct->IR.bit.MR0INT=1;
	return;
}
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
void TIM_EnableInt(G32F1_TIM_TypeDef *ct)
{
	ct->MCR.bit.MR0I=1;
	return;
}
...
Function Definition	void TIM_DisableInt(G32F1_TIM_TypeDef *ct)
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
void TIM_DisableInt(G32F1_TIM_TypeDef *ct)
{
	ct->MCR.bit.MR0I=0;
	return;	
}
...
Function Definition	void TIM_SetCTType(G32F1_TIM_TypeDef *ct, uint8_t mode)
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
void TIM_SetCTType(G32F1_TIM_TypeDef *ct, uint8_t mode)
{
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
void TIM_SelectTimerClearSignal(G32F1_TIM_TypeDef *ct, uint8_t capsignal, uint8_t edge)
{
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
void TIM_SelectPriSrc(G32F1_TIM_TypeDef *ct, uint8_t clksrc)
{
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
void TIM_SelectSecSrc (G32F1_TIM_TypeDef *ct, uint8_t clksrc, uint8_t polarity)
{
...
Function Definition	void TIM_ConfigMatch0(G32F1_TIM_TypeDef *ct, uint16_t ticks, uint8_t internalaction, uint8_t externalaction)
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
void TIM_ConfigMatch0(G32F1_TIM_TypeDef *ct, uint16_t ticks, uint8_t internalaction, uint8_t externalaction)
{
	ct->MR0.bit.MATCH=ticks;
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
void TIM_ConfigMatch1(G32F1_TIM_TypeDef *ct, uint16_t ticks, uint8_t internalaction, uint8_t externalaction)
{
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
void TIM_ConfigMatch2(G32F1_TIM_TypeDef *ct, uint16_t ticks, uint8_t internalaction, uint8_t externalaction)
{
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
void TIM_ConfigMatch3(G32F1_TIM_TypeDef *ct, uint16_t ticks, uint8_t internalaction, uint8_t externalaction)
{
	ct->MR1.bit.MATCH=ticks;
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
void TIM_ConfigCapture0(G32F1_TIM_TypeDef *ct, uint8_t edge, uint8_t intreq)
{
	switch(edge)
	{
		case RISE_EDGE:
...
Function Definition	void TIM_ConfigCapture1 (G32F1_TIM_TypeDef *ct, uint8_t edge, uint8_t intreq)
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
void TIM_ConfigCapture1(G32F1_TIM_TypeDef *ct, uint8_t edge, uint8_t intreq)
{
	switch(edge)
	{
		case RISE_EDGE:
...
Function Definition	void TIM_ConfigCapture2 (G32F1_TIM_TypeDef *ct, uint8_t edge, uint8_t intreq)
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
void TIM_ConfigCapture2(G32F1_TIM_TypeDef *ct, uint8_t edge, uint8_t intreq)
{
	switch(edge)
	{
		case RISE_EDGE:
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
void TIM_ConfigCapture3(G32F1_TIM_TypeDef *ct, uint8_t edge, uint8_t intreq)
{
	switch(edge)
	{
		case RISE_EDGE:
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
uint16_t TIM_GetCapture0Value (G32F1_TIM_TypeDef *ct)
{
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
uint16_t TIM_GetCapture1Value (G32F1_TIM_TypeDef *ct)
{
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
uint16_t TIM_GetCapture2Value (G32F1_TIM_TypeDef *ct)
{
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
uint16_t TIM_GetCapture3Value (G32F1_TIM_TypeDef *ct)
{
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
void TIM_START (G32F1_TIM_TypeDef *ct)
{
	ct->TCR.bit.CEN = 1;
}
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
void TIM_STOP(G32F1_TIM_TypeDef *ct)
{
	ct->TCR.bit.CEN = 0;
}
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
void TIM_RESET(G32F1_TIM_TypeDef *ct)
{
	ct->TCR.bit.CRST = 1;
	ct->TCR.bit.CRST = 0;
}
