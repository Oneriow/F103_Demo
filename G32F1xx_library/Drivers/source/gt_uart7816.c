...
Function Definition	void UART_Open(G32F1_UART_TypeDef *uart, uint32_t baudrate, uint8_t parityoption, uint8_t rxinttriggerlevel);
Function Description	Initial UART 
Input Parameters	*uart : pointer to UART device, GT_UART0/GT_UART1
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
// void UART7816_ClearFIFO(G32F1_UART7816_TypeDef *uart)
// {
